import { E as kindFromMime, S as getFileExtension, b as detectMime, w as isAudioFileName } from "./message-channel-DfmYEnql.js";
...
import { y as normalizeChatType } from "./plugins-BQilE2mk.js";
import { B as resolveIMessageAttachmentRoots, D as loadConfig, L as DEFAULT_IMESSAGE_ATTACHMENT_ROOTS, R as isInboundPathAllowed, Un as resolveOpenClawAgentDir, cr as normalizeGoogleModelId, i as resolveApiKeyForProvider, r as requireApiKey, tr as normalizeProviderId, z as mergeInboundPathRoots } from "./model-auth-kiHYHGrs.js";
import { n as fetchWithTimeout } from "./fetch-timeout-DpvMOIrx.js";
import { t as fetchWithSsrFGuard } from "./fetch-guard-BmqMmvPq.js";
import { C as ensureOpenClawModelsJson, t as describeImageWithModel } from "./image-gMD4OQpH.js";
import { n as executeWithApiKeyRotation, r as parseGeminiAuth, t as collectProviderApiKeysForExecution } from "./api-key-rotation-BOwwqQWh.js";
import { i as fetchRemoteMedia, n as getDefaultMediaLocalRoots, r as MediaFetchError } from "./local-roots-r2_TBHZS.js";
...
const defaultImportPiSdk = () => import("./pi-model-discovery-QkJwHeOB.js").then((n) => n.r);
