...
const defaultImportPiSdk = () => import("./pi-model-discovery-Kensib2E.js");
...
function ensureContextWindowCacheLoaded() {
	...
	loadPromise = (async () => {
		...
		try {
			const { discoverAuthStorage, discoverModels } = await import("./pi-model-discovery-Kensib2E.js");
			const agentDir = resolveOpenClawAgentDir();
