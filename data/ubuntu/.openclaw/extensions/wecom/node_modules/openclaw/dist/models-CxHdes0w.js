...
import { $t as formatUsageWindowSummary, Bt as DEFAULT_OAUTH_WARN_MS, Ht as formatRemainingShort, Rr as resolveModelWithRegistry, Vt as buildAuthHealthSummary, Zt as loadProviderUsageSummary, en as resolveUsageProviderId, er as runEmbeddedPiAgent, mr as describeFailoverError, zt as maskApiKey } from "./compact-B247y5Qt.js";
import { n as discoverModels, t as discoverAuthStorage } from "./pi-model-discovery-BU5iOFRu.js";
import { i as resolveSessionTranscriptPath, s as resolveSessionTranscriptsDirForAgent } from "./paths-BCX3TKIK.js";
import { t as ensureOpenClawModelsJson } from "./models-config-DXA5BkaM.js";
import { n as loadModelCatalog } from "./model-catalog-Ezhj-HLy.js";
import { i as getModelsCommandSecretTargetIds, s as resolveCommandSecretRefsViaGateway } from "./command-secret-targets-BPdIQBpp.js";
import { f as openUrl } from "./onboard-helpers-BB3T2pqg.js";
...
import { a as formatMs, c as loadValidConfigOrThrow, d as resolveKnownAgentId, f as resolveModelKeysFromEntries, i as ensureFlagCompatibility, l as mergePrimaryFallbackConfig, m as updateConfig, n as applyOpenAICodexModelDefault, o as formatTokenK, p as resolveModelTarget, r as applyDefaultModelPrimaryUpdate, s as isLocalBaseUrl, t as OPENAI_CODEX_DEFAULT_MODEL, u as normalizeAlias } from "./openai-codex-model-default-Cr-QCmbM.js";
import { Ct as writeOAuthCredentials, d as applyAuthProfileConfig, n as validateAnthropicSetupToken } from "./auth-token-DXCF3dFL.js";
import { n as logConfigUpdated } from "./logging-BfIBddi5.js";
import { a as loginOpenAICodexOAuth, c as resolvePluginProviders, i as resolveProviderMatch, n as mergeConfigPatch, o as createVpsAwareOAuthHandlers, r as pickAuthMethod, s as isRemoteEnvironment, t as applyDefaultModel } from "./provider-auth-helpers-D5_z82-N.js";
...
async function modelsListCommand(opts, runtime) {
	ensureFlagCompatibility(opts);
	const { ensureAuthProfileStore } = await import("./auth-profiles-5CHn7vq1.js").then((n) => n.t);
